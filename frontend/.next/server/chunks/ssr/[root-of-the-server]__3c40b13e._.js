...
const LoginForm = ({ className, ...props })=>{
    ...
    const googleLogin = async ()=>{
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].auth.signInWithOAuth({
            provider: "google",
            options: {
    ...
    const handleSubmit = async (values)=>{
        ...
        if (error) {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success("Login Success!");
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3c40b13e._.js.map