...
async function middleware(req) {
    ...
    if (isProtectedRoute && !user) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$web$2f$exports$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL("/auth/login", req.nextUrl.origin));
    }
    const authRoutes = [
        "/auth/login",
        "/auth/signup"
    ...
    if (isAuthRoute && user) {
        ...
        console.log(role);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$web$2f$exports$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL(role === "kami" ? "/kami/upload/anime" : "/home", req.nextUrl.origin));
    }
    if (user && user.user_metadata?.role === "kami" && req.nextUrl.pathname === "/home") {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$web$2f$exports$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL("/kami/upload/anime", req.nextUrl.origin));
    }
    if (user && user.user_metadata?.role === "user" && isProtectedRoute) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$web$2f$exports$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL("/home", req.nextUrl.origin));
    }
    return response;
}
const config = {
